...
SynthesisResult MultipleSynthesizer::synthesize() noexcept {
...
void MultipleSynthesizer::linkChunkMatching(int beam_index) noexcept {
...
MultipleSynthesizer::NpuID MultipleSynthesizer::selectSourceNpu(
...
bool MultipleSynthesizer::synthesisCompleted(int beam_index) const noexcept {
