...
class MultipleSynthesizer {
  public:
    ...
    MultipleSynthesizer(std::shared_ptr<Topology> topology,
  ...
  private:
    ...
    std::vector<CollectivePrecondition> beam_preconditions;
    std::vector<CollectivePostcondition> beam_postconditions;
